...
const char* testcommands_NONE[] = { "51-environment-cd %s/tests",
...
const char* testcommands_LARGE_CHAR_ARRAY[] = {
    "51-environment-cd %s/tests", "17-file-exec-and-symbols --thread-group i1 %s/build/tests",
    //	"19-gdb-show --thread-group i1 language",
    "53-gdb-set --thread-group i1 args %s",
    "26-break-insert -f %s/tests/src/tests.cpp:98", // breakpoint 1 in test_LARGE_CHAR_ARRAY()
    "28-exec-run --thread-group i1", "35-stack-list-locals --thread 1 --frame 0 1",
    "36-var-create --thread 1 --frame 0 - * ccc", "37-var-create --thread 1 --frame 0 - * &(ccc)",
    "38-stack-list-frames --thread 1", "39-var-create --thread 1 --frame 0 - * *((ccc)+0)@100",
    "39-var-create --thread 1 --frame 0 - * *((ccc)+100)@2", "40-exec-next --thread 1 1",
    "41-stack-list-locals --thread 1 --frame 0 1", "42-stack-info-depth --thread 1 11", "45-var-update 1 ccc",
    "46-var-update 1 $0", "47-var-update 1 c[100]", "80-gdb-exit", NULL
};
...
const char* testcommands_LARGE_ARRAY[] = {
    ...
    "28-exec-run --thread-group i1", "39-var-create --thread 1 --frame 0 - * *((i)+0)@100",
    "39-var-create --thread 1 --frame 0 - * *((s)+0)@100", "80-gdb-exit", NULL
};

const char* testcommands_POINTERS[] = {
    "51-environment-cd %s/tests", "52-file-exec-and-symbols --thread-group i1 %s/build/tests",
    "53-gdb-set --thread-group i1 args %s",
    "58-break-insert --thread-group i1 %s/tests/src/tests.cpp:136", // breakpoint 1 in test_POINTERS()
    "62-exec-run --thread-group i1", "64-list-thread-groups", "65-list-thread-groups i1", "69-thread-info 1",
    "67-stack-list-locals --thread 1 --frame 0 1", // ^done,locals=[{name="ab",value="{a = 0, b = 0}"}]
    "72-var-create --thread 1 --frame 0 - * x", "78-var-update 1 x", "79-var-update 1 px",
    "77-exec-next --thread-group i1", "64-list-thread-groups", "65-list-thread-groups i1", "69-thread-info 1",
    "67-stack-list-locals --thread 1 --frame 0 1", // ^done,locals=[{name="ab",value="{a = 0, b = 0}"}]
    "78-var-update 1 x", "79-var-update 1 px", "77-exec-next --thread-group i1", "64-list-thread-groups",
    "65-list-thread-groups i1", "69-thread-info 1",
    "67-stack-list-locals --thread 1 --frame 0 1", // ^done,locals=[{name="ab",value="{a = 0, b = 0}"}]
    "78-var-update 1 x", "79-var-update 1 px", "77-exec-next --thread-group i1", "64-list-thread-groups",
    "65-list-thread-groups i1", "69-thread-info 1",
    "67-stack-list-locals --thread 1 --frame 0 1", // ^done,locals=[{name="ab",value="{a = 0, b = 0}"}]
    "78-var-update 1 x", "79-var-update 1 px",
    //	"76-var-evaluate-expression pz->a",
    //	"76-var-evaluate-expression (pz)->a",
    //	"76-var-evaluate-expression pz.a",
    "80-gdb-exit", NULL
...
const char* testcommands_STRING[] = {
    ...
    "73-var-list-children \"s.__r_.std::__1::__libcpp_compressed_pair_imp<std::__1::basic_string<char, "
    "std::__1::char_traits<char>, std::__1::allocator<char> >::__rep, std::__1::allocator<char>, 2>\"",
    "73-var-list-children \"s.__r_.std::__1::__libcpp_compressed_pair_imp<std::__1::basic_string<char, "
    "std::__1::char_traits<char>, std::__1::allocator<char> >::__rep, std::__1::allocator<char>, 2>.__first_\"",
    ...
    "50-data-evaluate-expression --thread 1 --frame 0 \"cc.data.std::__1::__vector_base<unsigned char, "
...
const char* testcommands_OTHER[] = { "51-environment-cd %s/tests",
                                     "52-file-exec-and-symbols --thread-group i1 %s/build/tests",
                                     "53-gdb-set --thread-group i1 args %s",
...
const char* testcommands_CATCH_THROW[] = { "51-environment-cd %s/tests",
                                           "52-file-exec-and-symbols --thread-group i1 %s/build/tests",
                                           "53-gdb-set --thread-group i1 args %s",
                                           "61-inferior-tty-set --thread-group i1 %s", // stdout instead of /dev/ptyxx
                                           "41catch catch",
...
const char* testcommands_LO[] = {
    ...
    //ximpbody.cxx:253
    "61-inferior-tty-set --thread-group i1 %s", // stdout instead of /dev/ptyxx
    "62-exec-run --thread-group i1", "53-stack-list-frames --thread 1", "259-stack-list-locals --thread 1 --frame 1 1",
    "261-var-create --thread 1 --frame 1 - * this", "261-var-create --thread 1 --frame 1 - * nPrefix",
    "261-var-create --thread 1 --frame 1 - * rLocalName", "261-var-create --thread 1 --frame 1 - * xAttrList",
    "261-var-create --thread 1 --frame 1 - * pContext", "266-var-list-children this",
    "270-var-info-path-expression this->maStyleName", "280-var-list-children this->maName",
    "283-var-list-children this->maName.pData", "286-var-info-path-expression this->maName.pData->buffer",
    ...
    "338-var-create --thread 1 --frame 1 - * this->maName.pData->buffer[0]", "80-gdb-exit", NULL
};
...
#ifdef WITH_TESTS
    case 1:
        return testcommands_THREAD;
    case 2:
        return testcommands_VARS;
    case 3:
        return testcommands_UPDATE;
    case 4:
        return testcommands_LARGE_CHAR_ARRAY;
    case 5:
        return testcommands_LARGE_ARRAY;
    case 6:
        return testcommands_POINTERS;
    case 7:
        return testcommands_ATTACH;
    case 8:
        return testcommands_MEMBERS;
    case 9:
        return testcommands_STRING;
    case 10:
        return testcommands_ARGS;
    case 11:
        return testcommands_CRASH;
    case 12:
        return testcommands_INPUT;
    case 13:
        return testcommands_CATCH_THROW;
    case 14:
        return testcommands_OTHER;
    case 15:
        return testcommands_BIG_CLASS;
    case 16:
        return testcommands_LONG_INHERITANCE;
#endif // WITH_TESTS
#ifdef WITH_LO_TESTS
    case 31:
        return testcommands_LO;
#endif // WITH_LO_TESTS
    default:
        return testcommands_NONE;
    }
}
